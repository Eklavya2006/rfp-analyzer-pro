...
// ── Email share helper ────────────────────────────────────────
async function shareViaEmail(clientName: string, projectTitle: string) {
  const subject = `RFP Proposal — ${projectTitle} for ${clientName}`;
  const body    = `Hi,\n\nPlease find attached the proposal for ${projectTitle}.\n\nThis was generated by IBM RFP Analyzer Pro.\n\nBest regards`;
  ...
  // Always open mailto — user fills in recipient in their mail client
