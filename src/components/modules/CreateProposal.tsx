...
function buildProposalHTML(opts: {
  ...
  const { clientName, projectTitle, date, result, logoDataUrl, withLogo } = opts;
...
export default function CreateProposalModule() {
  ...
  const generate = () => {
    const html = buildProposalHTML({ clientName, projectTitle, date, result, logoDataUrl, withLogo });
